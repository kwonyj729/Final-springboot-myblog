...
function makeCommentItem(r) {
	...
	comment_item += `<div class="badge badge-pill ml-auto">[작성자] ${r.username}</div>`;
	comment_item += `<button onclick="commentDelete(${r.id})" class="badge badge-secondary">삭제</button>`;
	comment_item += `</li>`;
